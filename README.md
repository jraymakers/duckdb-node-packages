...
{
  "dependencies": {
    "@jraymakers/duckdb-node-api": "^0.0.2"
  }
}
```
...
- `@jraymakers/duckdb-node-api`
- `@jraymakers/duckdb-node-bindings`
- `@jraymakers/duckdb-node-bindings-darwin-arm64`
...
Example (`test.mjs`):
```
import duckdb, { DuckDBInstance, DuckDBTypeId } from '@jraymakers/duckdb-node-api';
